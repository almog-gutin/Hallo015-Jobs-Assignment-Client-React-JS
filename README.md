...
<h1 align="center">Hallo015 Jobs Assignment Client React JavaScript</h1>
...
This client-side application is is part of the Hallo015 jobs assignment.

It is built with the React library to build a single page application.

In the homepage of the application there is a table and a chart that displays different data about certain jobs.
